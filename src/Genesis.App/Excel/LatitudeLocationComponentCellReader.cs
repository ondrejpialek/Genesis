...
{
    /// <summary>
    /// Sets the latitude component of the <see cref="Locality.Location" /> property.
    /// </summary>
    public class LatitudeLocationComponentCellReader : CellReader<Locality, string>
    {
        public LatitudeLocationComponentCellReader() : base("Latitude") { }
